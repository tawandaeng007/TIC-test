// Values are placeholders; update valueBaht when the clinic confirms prices.
// Weights are per-spin probabilities, not a guaranteed distribution or stock count.
export const prizes = Object.freeze([
  { id: "gold", name: "ทอง 25 สตางค์", lines: ["ทอง", "25 สตางค์"], weight: 1, valueBaht: 100 },
  { id: "chanel", name: "ฉีดหน้าใส Chanel", lines: ["ฉีดหน้าใส", "Chanel"], weight: 4, valueBaht: 100 },
  { id: "botox", name: "Botox (Korea) 50U", lines: ["Botox (Korea)", "50U"], weight: 4, valueBaht: 100 },
  { id: "mono", name: "ร้อยไหม Mono 10 เส้น", lines: ["ร้อยไหม Mono", "10 เส้น"], weight: 4, valueBaht: 100 },
  { id: "hifu", name: "Hifu 50 Shots", lines: ["Hifu", "50 Shots"], weight: 4, valueBaht: 100 },
  { id: "spoon", name: "Golden Spoon Tm.", lines: ["Golden", "Spoon Tm."], weight: 8, valueBaht: 100 },
  { id: "g8", name: "G8 (10 mins)", lines: ["G8", "(10 mins)"], weight: 10, valueBaht: 100 },
  { id: "laser", name: "Laser รักแร้", lines: ["Laser", "รักแร้"], weight: 15, valueBaht: 100 },
  { id: "biolight", name: "BioLight (5 mins)", lines: ["BioLight", "(5 mins)"], weight: 20, valueBaht: 100 },
  { id: "mask", name: "Tm. Mask", lines: ["Tm. Mask"], weight: 30, valueBaht: 100 },
