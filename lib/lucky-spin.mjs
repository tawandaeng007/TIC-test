...
export const prizes = Object.freeze([
  { id: "gold", name: "ทอง 25 สตางค์", lines: ["ทอง", "25 สตางค์"], weight: 0, valueBaht: 100 },
  ...
  { id: "biolight", name: "BioLight (5 mins)", lines: ["BioLight", "(5 mins)"], weight: 31, valueBaht: 100 },
  { id: "mask", name: "Tm. Mask", lines: ["Tm. Mask"], weight: 20, valueBaht: 100 },
