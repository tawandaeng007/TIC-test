...
export const prizes = Object.freeze([
  ...
  { id: "chanel", name: "ฉีดหน้าใส Chanel", lines: ["ฉีดหน้าใส", "Chanel"], weight: 5, valueBaht: 100 },
  { id: "botox", name: "Botox (Korea) 50U", lines: ["Botox (Korea)", "50U"], weight: 3, valueBaht: 100 },
  { id: "mono", name: "ร้อยไหม Mono 10 เส้น", lines: ["ร้อยไหม Mono", "10 เส้น"], weight: 3, valueBaht: 100 },
  { id: "hifu", name: "Hifu 50 Shots", lines: ["Hifu", "50 Shots"], weight: 5, valueBaht: 100 },
  { id: "spoon", name: "Golden Spoon Tm.", lines: ["Golden", "Spoon Tm."], weight: 10, valueBaht: 100 },
  { id: "g8", name: "G8 (10 mins)", lines: ["G8", "(10 mins)"], weight: 8, valueBaht: 100 },
