...
export const catalog: CatalogItem[] = [
  ...
  { id: "triple-aura", tag: "Vitamin", title: "Triple Aura", shortTitle: "Triple Aura", detail: "ดริปวิตามินสูตร Triple Aura ราคาเริ่มต้น 1 กระปุก", price: 1900, image: "/images/promotions/triple-aura.jpg", category: "ดริปวิตามิน" },
